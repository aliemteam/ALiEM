...
<head>
	...
	<link rel="manifest" href="/wp-content/themes/aliem.com/manifest.json">
	<?php echo Avada()->settings->get( 'google_analytics' ); // phpcs:ignore ?>
	<?php wp_head(); ?>
</head>

<?php $wrapper_class = ( is_page_template( 'blank.php' ) ) ? 'wrapper_blank' : ''; ?>
<body <?php body_class(); ?>>
