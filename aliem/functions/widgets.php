...
class BookclubWidget extends WP_Widget {
	...
	public function form($instance) {
		...
		$instance = wp_parse_args((array) $instance, $defaults); ?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_attr_e('Next book title:', 'Avada'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('date'); ?>"><?php esc_attr_e('Date:', 'Avada'); ?></label>
