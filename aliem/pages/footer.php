        ...
        <footer role="contentinfo" class="footer__container">
            ...
            <div class="footer__grid">
                ...
                <div class="footer__grid__item">
                    <h3>Partners</h3>
                    <ul>
                        <li><a href="http://www.call9.com/" target="_blank" rel="noopener noreferrer">Call9</a></li>
                        <li><a href="http://westjem.com/" target="_blank" rel="noopener noreferrer">WestJEM</a></li>
                        <li><a href="http://www.dynamed.com/" target="_blank" rel="noopener noreferrer">DynaMed Plus</a></li>
                        <li><a href="https://flippingmeded.com/" target="_blank" rel="noopener noreferrer">The Teaching Institute</a></li>
                    </ul>
                </div>
            </div>
